...
{
    uint8 staticBits = (MV1_DR & (uint8)(~MV1_MASK));
    MV1_DR = staticBits | ((uint8)(value << MV1_SHIFT) & MV1_MASK);
}
...
{
	CyPins_SetPinDriveMode(MV1_0, mode);
}
...
uint8 MV1_Read(void) 
{
    return (MV1_PS & MV1_MASK) >> MV1_SHIFT;
}
...
{
    return (MV1_DR & MV1_MASK) >> MV1_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (MV1_INTSTAT & MV1_MASK) >> MV1_SHIFT;
    }
