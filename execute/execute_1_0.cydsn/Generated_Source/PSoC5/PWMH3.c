...
{
    uint8 staticBits = (PWMH3_DR & (uint8)(~PWMH3_MASK));
    PWMH3_DR = staticBits | ((uint8)(value << PWMH3_SHIFT) & PWMH3_MASK);
}
...
{
	CyPins_SetPinDriveMode(PWMH3_0, mode);
}
...
{
    return (PWMH3_PS & PWMH3_MASK) >> PWMH3_SHIFT;
}
...
{
    return (PWMH3_DR & PWMH3_MASK) >> PWMH3_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (PWMH3_INTSTAT & PWMH3_MASK) >> PWMH3_SHIFT;
    }
