...
#define USBUART_1_EP_MM                          (1u)
#define USBUART_1_EP_MA                          (0u)
#define USBUART_1_EP_DMA_AUTO_OPT                (0u)
#define USBUART_1_DMA1_REMOVE                    (0u)
#define USBUART_1_DMA2_REMOVE                    (0u)
#define USBUART_1_DMA3_REMOVE                    (0u)
...
#define USBUART_1_MSOS_CONF_DESCR_LENGTH         (40u)
    ...
    #endif /* USBUART_1_DMA1_REMOVE == 0u */
    ...
    #endif /* USBUART_1_DMA2_REMOVE == 0u */
    ...
    #endif /* USBUART_1_DMA3_REMOVE == 0u */
    ...
    #endif /* USBUART_1_DMA4_REMOVE == 0u */
    ...
    #endif /* USBUART_1_DMA5_REMOVE == 0u */
    ...
    #endif /* USBUART_1_DMA6_REMOVE == 0u */
    ...
    #endif /* USBUART_1_DMA7_REMOVE == 0u */
    ...
    #endif /* USBUART_1_DMA8_REMOVE == 0u */
...
#define USBUART_1_DP_INTSTAT_REG     (* (reg8 *) USBUART_1_Dp__INTSTAT)
    ...
    #endif /*  USBUART_1_EXTERN_VBUS == 0u */
#endif /*  USBUART_1_MON_VBUS */
