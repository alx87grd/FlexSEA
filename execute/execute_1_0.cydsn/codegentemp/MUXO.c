...
{
    uint8 staticBits = (MUXO_DR & (uint8)(~MUXO_MASK));
    MUXO_DR = staticBits | ((uint8)(value << MUXO_SHIFT) & MUXO_MASK);
}
...
{
	CyPins_SetPinDriveMode(MUXO_0, mode);
}
...
{
    return (MUXO_PS & MUXO_MASK) >> MUXO_SHIFT;
}
...
{
    return (MUXO_DR & MUXO_MASK) >> MUXO_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (MUXO_INTSTAT & MUXO_MASK) >> MUXO_SHIFT;
    }
