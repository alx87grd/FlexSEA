...
#define PWM_2_INIT_COMPARE_VALUE1        (127u)
#define PWM_2_INIT_COMPARE_VALUE2        (127u)
...
#define PWM_2_DEFAULT_COMPARE2_MODE      (uint8)((uint8)3u <<  PWM_2_CTRL_CMPMODE2_SHIFT)
#define PWM_2_DEFAULT_COMPARE1_MODE      (uint8)((uint8)1u <<  PWM_2_CTRL_CMPMODE1_SHIFT)
#define PWM_2_INIT_DEAD_TIME             (255u)
